...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.textOrButton = getRemoteConfigString('CreateAccountButton');
      safeSetState(() {});
    });
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 250.0,
                      child: TextFormField(
                        key: ValueKey('Login-Password_50pp'),
                    ...
                    FFButtonWidget(
                      key: ValueKey('Login-Button_5f4j'),
                      onPressed: () async {
                    ...
                    if (getRemoteConfigString('sign_up_style') == 'text_link')
                      Align(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent('LOGIN_PAGE_Text_2ppekp5m_ON_TAP');

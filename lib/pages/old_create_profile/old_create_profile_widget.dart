...
import 'old_create_profile_model.dart';
export 'old_create_profile_model.dart';

class OldCreateProfileWidget extends StatefulWidget {
  const OldCreateProfileWidget({super.key});

  static String routeName = 'oldCreateProfile';
  static String routePath = '/oldCreateProfile';

  @override
  State<OldCreateProfileWidget> createState() => _OldCreateProfileWidgetState();
}

class _OldCreateProfileWidgetState extends State<OldCreateProfileWidget> {
  late OldCreateProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OldCreateProfileModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'oldCreateProfile'});
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'OLD_CREATE_PROFILE_Stack_9why5lln_ON_TAP');
                              logFirebaseEvent(
                            ...
                            child: Stack(
                              ...
                              children: [
                                ...
                                FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'OLD_CREATE_PROFILE_PAGE_add_ICN_ON_TAP');
                                  },
                                ),
                              ],
                            ),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'OLD_CREATE_PROFILE_SET_BIRTHDAY_BTN_ON_T');

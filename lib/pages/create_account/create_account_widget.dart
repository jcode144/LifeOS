                  ...
                  children: [
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsetsDirectional.fromSTEB(
                              17.0, 22.0, 17.0, 22.0),
                          suffixIcon: _model
                                  .createEmailTextController!.text.isNotEmpty
                              ? InkWell(
                                  onTap: () async {
                                    _model.createEmailTextController?.clear();
                                    safeSetState(() {});
                                  },
                                  child: Icon(
                                    Icons.clear,
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        cursorColor: FlutterFlowTheme.of(context).primaryText,
                        enableInteractiveSelection: true,
                        validator: _model.createPasswordTextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                    Container(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        if (_model.createPasswordTextController.text !=
                            _model.createConfirmPassowrdTextController.text) {
                        ...
                        final user = await authManager.createAccountWithEmail(
                          context,
                          _model.createEmailTextController.text,
                        ...
                        await UsersRecord.collection
                            ...
                            .update(createUsersRecordData(
                              email: _model.createEmailTextController.text,
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            logFirebaseEvent(
                                'CREATE_ACCOUNT_PAGE_Icon_f5ara50p_ON_TAP');
